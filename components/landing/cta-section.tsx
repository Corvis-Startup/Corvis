      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <div 
            ...
            style={{
              background: `radial-gradient(600px circle at ${mousePosition.x}% ${mousePosition.y}%, oklch(0.8 0.16 155 / 0.12), transparent 40%)`
            }}
          />
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              <div className="flex-1">
                <h2 className="text-4xl lg:text-6xl font-display tracking-tight mb-8 leading-[0.98] text-balance">
                  Don&apos;t let your best
                  <br />
                  engineers walk out with
                  <br />
                  your company&apos;s memory.
                </h2>

                <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-xl text-pretty">
                ...
                <p className="text-sm text-muted-foreground mt-8 font-mono">
                  Pre-launch · onboarding design partners now
                </p>
              </div>
